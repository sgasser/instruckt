...
`).trim()}getAnnotations(){return[...this.annotations]}destroy(){var t,e,n,o;this.setAnnotating(!1),this.setFrozen(!1),document.removeEventListener("keydown",this.boundKeydown),window.removeEventListener("scroll",this.boundReposition),window.removeEventListener("resize",this.boundReposition),(t=this.toolbar)==null||t.destroy(),(e=this.highlight)==null||e.destroy(),(n=this.popup)==null||n.destroy(),(o=this.markers)==null||o.destroy(),this.rafId!==null&&cancelAnimationFrame(this.rafId)}};y.STORAGE_KEY="instruckt:annotations";var x=y;function bt(i){return new x(i)}return ot(kt);})();
